...
In toki pona, dunque, tutti i nomi sono aggettivi, e devono essere sempre retti da un sostantivo -- che noi chiamiamo *termine reggente*[^1]. Questo significa che potete scegliere un termine reggente con cui vi conosceranno.
...
**Quinto**, se alcune vocali sono adiacenti tra loro, si aggiunge j or w nel mezzo: *Nihon* (Giappone) → *Nion* → *Nijon*; *Leandro* → *Lejanto*; *Laerte* → *Lawete*.
...
[^1]: in Inglese *head noun*; si ringrazia il collega Prof Alessandro Orfano per il suggerimento. Una possibile traduzione alternativa potrebbe essere *caponome* (sulla falsariga di *capotasto*, *capocorda* o *capoverso*); ma *termine reggente* è più corretto dal punto di vista della terminologia grammaticale.
